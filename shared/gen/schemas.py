...
class ChatUsage(BaseModel):
    ...
    cache_read_in_prompt: Optional[bool] = None
...
class ChatToolCallDeltaFunction(BaseModel):
    name: Optional[str] = None
...
class ChatToolCallDelta(BaseModel):
    ...
    function: Optional[ChatToolCallDeltaFunction] = None

class ChatDelta(BaseModel):
    role: Optional[str] = None
    content: Optional[str] = None
    tool_calls: Optional[List[ChatToolCallDelta]] = None
