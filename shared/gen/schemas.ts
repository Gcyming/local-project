...
export const ChatMessage = z.object({ role: z.enum(['system', 'user', 'assistant', 'tool']), content: z.string().nullable(), name: z.string().optional(), tool_call_id: z.string().optional(), reasoning_content: z.string().optional(), tool_calls: z.array(ChatToolCall).optional() });
...
export const ChatUsage = z.object({ prompt_tokens: z.number().optional(), completion_tokens: z.number().optional(), total_tokens: z.number().optional(), cache_read_tokens: z.number().optional(), cache_creation_tokens: z.number().optional(), cache_read_in_prompt: z.boolean().optional() });
...
export const ChatToolCallDeltaFunction = z.object({ name: z.string().optional(), arguments: z.string().optional() });
export type ChatToolCallDeltaFunction = z.infer<typeof ChatToolCallDeltaFunction>;

export const ChatToolCallDelta = z.object({ index: z.number().optional(), id: z.string().optional(), type: z.string().optional(), function: ChatToolCallDeltaFunction.optional() });
export type ChatToolCallDelta = z.infer<typeof ChatToolCallDelta>;

export const ChatDelta = z.object({ role: z.string().optional(), content: z.string().optional(), tool_calls: z.array(ChatToolCallDelta).optional() });
